		...
		<div id="side_bar" class="span5">
		 <div class="padding">
		  ...
		  <div class="testimonial testi-home">
			<h3 style="padding:10px 180px 0 0;">Why Qwest</h3>
